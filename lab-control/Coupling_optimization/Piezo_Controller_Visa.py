...
class Piezo_Controller_Thorlabs:
    ...
    def set_yz_voltage(self, x_voltage, y_voltage, z_voltage):
        ...
        """
        if y_voltage == self.y_voltage_set and z_voltage == self.z_voltage_set :
            return 1
    ...
    def get_x_voltage(self):
        ...
        voltage = vol.value
        print(f'this is the x-voltage: {voltage}')
        return voltage
    ...
    def get_y_voltage(self):
        ...
        voltage = vol.value
        print(f'this is the y-voltage: {voltage}')
        return voltage
    ...
    def get_z_voltage(self):
        ...
        voltage = vol.value
        print(f'this is the z-voltage: {voltage}')
    ...
    def load_settings(self):
        with open(self.settings_path, "r") as text_file:
            ...
            self.set_x_voltage(self.get_x_voltage())
            self.set_y_voltage(self.get_y_voltage())
            self.set_z_voltage(self.get_z_voltage())
