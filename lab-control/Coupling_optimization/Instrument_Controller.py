...
class Instrument_Controller:
    def __init__(self):
        ...
        self.settings_path = r"C:\Users\Group Login\Documents\Simon\AU\instrument_controller_settings.txt"
        self.resource_manager = visa.ResourceManager()
        self.detector_list = [0,0]
        self.laser_list = []
        self.piezo_list = []
        ...
        self.feedback_detector_index = None
    ...
    def load_settings(self):
        with open(self.settings_path, "r") as text_file:
            ...
            self.feedback_detector_index = settings_dict["feedback_detector_index"]
    ...
    def open_instruments(self):
        if not self.instrument_connected_bool:
            ...
            for resource in resource_list:
                ...
                if resource == "USB0::0x1313::0x8078::P0024530::0::INSTR":  #Changed to PM100 in our setup
                ...
                if resource == "USB0::0x1313::0x8031::M00608302::0::INSTR": #Changed to PM101 (feedback powermeter) in our setup
    ...
    def open_output_piezo(self):
        settings_path = r"C:\Users\Group Login\Documents\Simon\AU\PICLAB-main\Projects\QVersion\Settings\output_piezo_controller_settings.txt"
        try:
    ...
    def open_input_piezo(self):
        settings_path = r"C:\Users\Group Login\Documents\Simon\AU\PICLAB-main\Projects\QVersion\Settings\input_piezo_controller_settings.txt"
        try:
            self.input_piezo_controller = Piezo_Controller_Thorlabs(settings_path, '1904235209-08')
    ...
    def open_thorlabs_55(self, resource):
        if resource == 'USB0::0x1313::0x8078::P0024530::0::INSTR':
            PM_index = 1
        else:
            PM_index = 1
        settings_path = "C:/Users/Group Login/Documents/Simon/AU/PICLAB-main/Projects/Qversion/Settings/thorlabs_55_settings.txt"
        
        detector = Thorlabs_PM100U(self.resource_manager, resource, settings_path, PM_index = PM_index)
        self.detector_list[0] = detector
        #except:
         #   print("Could not connect to Thorlabs 55")
         
    def open_thorlabs_56(self, resource):
        if resource == 'USB0::0x1313::0x8031::M00608302::0::INSTR':
            PM_index = 0
        else:
            PM_index = 0
        settings_path = "C:/Users/Group Login/Documents/Simon/AU/PICLAB-main/Projects/Qversion/Settings/thorlabs_55_settings.txt"
    ...
    def set_feedback_detector_index(self, index):
        self.feedback_detector_index = np.mod(index, len(self.detector_list))
    ...
    def get_target_detector(self):
        ...
        return self.detector_list[0]

    def get_feedback_detector(self):
        print(self.detector_list)
        return self.detector_list[1]
    ...
    def get_feedback_detector_index(self):
        return np.mod(self.feedback_detector_index, len(self.detector_list))
